...
To build the final jar and optimize the fixedAssets application for production, run:
...
Then navigate to [http://localhost:12001](http://localhost:12001) in your browser.
