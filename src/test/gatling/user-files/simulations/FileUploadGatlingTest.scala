...
/**
 * Performance test for the FileUpload entity.
 */
class FileUploadGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the FileUpload entity")
        ...
        .repeat(2) {
            ...
            .check(status.is(201))
            .check(headerRegex("Location", "(.*)").saveAs("new_fileUpload_url"))).exitHereIfFailed
            .pause(10)
            .repeat(5) {
