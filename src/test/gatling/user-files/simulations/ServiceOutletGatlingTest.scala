...
/**
 * Performance test for the ServiceOutlet entity.
 */
class ServiceOutletGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ServiceOutlet entity")
        ...
        .repeat(2) {
            ...
            .body(StringBody("""{
                ...
                , "serviceOutletDesignation":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("${new_serviceOutlet_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created serviceOutlet")
            .delete("${new_serviceOutlet_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
