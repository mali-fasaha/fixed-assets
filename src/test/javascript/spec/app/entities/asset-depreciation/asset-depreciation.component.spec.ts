...
import { AssetDepreciationComponent } from 'app/entities/asset-depreciation/asset-depreciation.component';
...
describe('Component Tests', () => {
  describe('AssetDepreciation Management Component', () => {
    let comp: AssetDepreciationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AssetDepreciationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new AssetDepreciation(123)],
            headers
          })
        )
      );
      ...
      expect(comp.assetDepreciations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
