...
import { ScannedDocumentComponent } from 'app/entities/scanned-document/scanned-document.component';
...
describe('Component Tests', () => {
  describe('ScannedDocument Management Component', () => {
    let comp: ScannedDocumentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ScannedDocumentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.scannedDocuments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
