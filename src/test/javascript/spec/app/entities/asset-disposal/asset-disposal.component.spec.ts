...
import { AssetDisposalComponent } from 'app/entities/asset-disposal/asset-disposal.component';
...
describe('Component Tests', () => {
  describe('AssetDisposal Management Component', () => {
    let comp: AssetDisposalComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AssetDisposalComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.assetDisposals[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
