...
describe('Service Tests', () => {
  describe('MessageToken Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new MessageToken(0, 'AAAAAAA', 0, 'AAAAAAA', false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a MessageToken', async () => {
      ...
      it('should update a MessageToken', async () => {
        const returnedFromService = Object.assign(
          {
            description: 'BBBBBB',
            timeSent: 1,
      ...
      it('should return a list of MessageToken', async () => {
        const returnedFromService = Object.assign(
          {
            description: 'BBBBBB',
            timeSent: 1,
      ...
      it('should delete a MessageToken', async () => {
