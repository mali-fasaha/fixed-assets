...
describe('Component Tests', () => {
  describe('AssetAcquisition Management Component', () => {
    let comp: AssetAcquisitionComponent;
    let fixture: ComponentFixture<AssetAcquisitionComponent>;
    let service: AssetAcquisitionService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [FixedAssetsTestModule],
        declarations: [AssetAcquisitionComponent],
        providers: [
          {
        ...
        .overrideTemplate(AssetAcquisitionComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(AssetAcquisitionComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.assetAcquisitions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
