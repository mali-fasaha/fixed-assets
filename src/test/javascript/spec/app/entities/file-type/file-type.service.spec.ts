...
describe('Service Tests', () => {
  describe('FileType Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a FileType', async () => {
      ...
      it('should update a FileType', async () => {
        const returnedFromService = Object.assign(
          {
            fileTypeName: 'BBBBBB',
      ...
      it('should return a list of FileType', async () => {
        const returnedFromService = Object.assign(
          {
            fileTypeName: 'BBBBBB',
            fileMediumType: 'BBBBBB',
      ...
      it('should delete a FileType', async () => {
