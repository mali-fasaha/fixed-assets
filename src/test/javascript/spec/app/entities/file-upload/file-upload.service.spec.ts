...
describe('Service Tests', () => {
  describe('FileUpload Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a FileUpload', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            periodFrom: currentDate.format(DATE_FORMAT),
      ...
      it('should update a FileUpload', async () => {
        const returnedFromService = Object.assign(
          {
            description: 'BBBBBB',
            fileName: 'BBBBBB',
      ...
      it('should return a list of FileUpload', async () => {
        const returnedFromService = Object.assign(
          {
            description: 'BBBBBB',
            fileName: 'BBBBBB',
      ...
      it('should delete a FileUpload', async () => {
