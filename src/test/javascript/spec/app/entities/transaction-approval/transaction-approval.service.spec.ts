...
describe('Service Tests', () => {
  describe('TransactionApproval Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a TransactionApproval', async () => {
      ...
      it('should update a TransactionApproval', async () => {
        const returnedFromService = Object.assign(
          {
            description: 'BBBBBB',
            requestedBy: 1,
      ...
      it('should return a list of TransactionApproval', async () => {
        const returnedFromService = Object.assign(
          {
            description: 'BBBBBB',
            requestedBy: 1,
      ...
      it('should delete a TransactionApproval', async () => {
