...
import { FixedAssetCategoryComponent } from 'app/entities/fixed-asset-category/fixed-asset-category.component';
...
describe('Component Tests', () => {
  describe('FixedAssetCategory Management Component', () => {
    let comp: FixedAssetCategoryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FixedAssetCategoryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new FixedAssetCategory(123)],
            headers
          })
        )
      );
      ...
      expect(comp.fixedAssetCategories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
