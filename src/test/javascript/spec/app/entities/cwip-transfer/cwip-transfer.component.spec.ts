...
describe('Component Tests', () => {
  describe('CwipTransfer Management Component', () => {
    let comp: CwipTransferComponent;
    let fixture: ComponentFixture<CwipTransferComponent>;
    let service: CwipTransferService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [FixedAssetsTestModule],
        declarations: [CwipTransferComponent],
        providers: [
          {
        ...
        .overrideTemplate(CwipTransferComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(CwipTransferComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cwipTransfers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
