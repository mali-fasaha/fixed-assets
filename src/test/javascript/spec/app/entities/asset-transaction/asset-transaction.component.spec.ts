...
import { AssetTransactionComponent } from 'app/entities/asset-transaction/asset-transaction.component';
...
describe('Component Tests', () => {
  describe('AssetTransaction Management Component', () => {
    let comp: AssetTransactionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AssetTransactionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.assetTransactions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
