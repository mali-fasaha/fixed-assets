...
export class FileUploadComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.fileUploadService
        ...
        .subscribe(
          (res: HttpResponse<IFileUpload[]>) => this.paginateFileUploads(res.body, res.headers),
  ...
  trackId(index: number, item: IFileUpload) {
    return item.id;
  }
  ...
  protected paginateFileUploads(data: IFileUpload[], headers: HttpHeaders) {
