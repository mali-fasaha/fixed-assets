...
@Component({
  selector: 'gha-asset-acquisition',
  templateUrl: './asset-acquisition.component.html'
})
export class AssetAcquisitionComponent implements OnInit, OnDestroy {
  currentAccount: any;
  ...
  transition() {
    this.router.navigate(['/asset-acquisition'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  protected paginateAssetAcquisitions(data: IAssetAcquisition[], headers: HttpHeaders) {
