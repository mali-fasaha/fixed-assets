...
@Component({
  selector: 'gha-asset-depreciation-data-table',
  templateUrl: './asset-depreciation-data-table.component.html',
  styleUrls: ['./asset-depreciation-data-table.component.scss']
})
export class AssetDepreciationDataTableComponent implements OnInit, OnDestroy {
  ...
  loadAmortizationEntities() {
    this.assetAcquisitionDataTableService.fetchAllAssetAcquisitions().subscribe(res => {
      this.assetDepreciations = res.body;
      this.dtTrigger.next();
    });
  }
