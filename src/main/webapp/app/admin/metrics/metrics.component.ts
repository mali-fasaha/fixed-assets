...
import { GhaMetricsService } from './metrics.service';

@Component({
  selector: 'gha-metrics',
  templateUrl: './metrics.component.html'
})
export class GhaMetricsMonitoringComponent implements OnInit {
  metrics: any = {};
  threadData: any = {};
  updatingMetrics = true;
  JCACHE_KEY: string;

  constructor(private modalService: NgbModal, private metricsService: GhaMetricsService) {
